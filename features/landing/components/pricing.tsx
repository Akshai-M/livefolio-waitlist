...
import { formatInr, formatUsd, pricingPlans } from "@/lib/pricing";
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <span className="text-2xl font-bold tabular-nums md:text-3xl">
                  {formatUsd(plan.monthlyAmount.usd)}
                </span>
                <span className="text-xl font-semibold tabular-nums text-zinc-400 md:text-2xl">
                  {formatInr(plan.monthlyAmount.inr)}
                </span>
                {plan.pricePeriod ? (
